...
//  WeSide
//
//  Created by Yusuf Shamtoot on 09/04/2023.
//
...
class PrivacyViewController: UIViewController {
    ...
    @IBOutlet weak var privacyStatement: UILabel!
    
    
    override func viewDidLoad() {
        super.viewDidLoad()
        privacyStatement.text = privacyStatementTemp
